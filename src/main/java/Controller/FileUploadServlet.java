...
public class FileUploadServlet extends HttpServlet {
    /**
     Questa Servlet ha come scopo quello di inserire un immagine per andare
     ad aggiornare la foto di un prodotto.
     */
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("id_prodottoImmagine", id_prodotto);

        ProdottoDAO prodottoDAO = new ProdottoDAO();
        try {
            prodottoDAO.doUpdateImmagine(id_prodotto, message);
